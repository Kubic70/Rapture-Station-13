/obj/item/organ/genital/penis
	...
	var/length = 6 //inches
	var/max_length = 9	// rapture added
	var/min_length = 2	// rapture added
...
/obj/item/organ/genital/penis/modify_size(modifier, min = -INFINITY, max = INFINITY)
	var/new_value = clamp(length + modifier, max(min, min_size ? min_size : -INFINITY), min(max_length ? max_length : INFINITY, max))	// rapture edit
	if(new_value == length)
		return
	prev_length = length
...
/obj/item/organ/genital/penis/get_features(mob/living/carbon/human/H)
	...
	max_length = D.features["cock_max_length"]	// rapture added
	min_length = D.features["cock_min_length"]	// rapture added
